...
class ChartsBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form = $this->chartsBaseSettingsForm->getChartsBaseSettingsForm($form, $this->defaults->getDefaults(), $field_options, $parents, 'block');
    ...
    $form['display']['data_markers']['#default_value'] = $this->configuration['data_markers'];
    ...
    $form['display']['dimensions']['height_units']['#default_value'] = $this->configuration['height_units'];

    unset($form['display']['dimensions']['width_units']['#parents']);
    $form['display']['dimensions']['width_units']['#default_value'] = $this->configuration['width_units'];

    unset($form['display']['gauge']['#parents']);
    $form['display']['gauge']['#default_value'] = $this->configuration['gauge'];

    unset($form['display']['gauge']['green_to']['#parents']);
    $form['display']['gauge']['green_to']['#default_value'] = $this->configuration['green_to'];

    unset($form['display']['gauge']['green_from']['#parents']);
    $form['display']['gauge']['green_from']['#default_value'] = $this->configuration['green_from'];

    unset($form['display']['gauge']['yellow_to']['#parents']);
    $form['display']['gauge']['yellow_to']['#default_value'] = $this->configuration['yellow_to'];

    unset($form['display']['gauge']['yellow_from']['#parents']);
    $form['display']['gauge']['yellow_from']['#default_value'] = $this->configuration['yellow_from'];

    unset($form['display']['gauge']['red_to']['#parents']);
    $form['display']['gauge']['red_to']['#default_value'] = $this->configuration['red_to'];

    unset($form['display']['gauge']['red_from']['#parents']);
    $form['display']['gauge']['red_from']['#default_value'] = $this->configuration['red_from'];

    unset($form['display']['gauge']['max']['#parents']);
    $form['display']['gauge']['max']['#default_value'] = $this->configuration['max'];

    unset($form['display']['gauge']['min']['#parents']);
    $form['display']['gauge']['min']['#default_value'] = $this->configuration['min'];
    ...
    $form['yaxis']['title']['#default_value'] = $this->configuration['yaxis_title'];
    ...
    unset($form['yaxis']['inherit_yaxis']['#parents']);
    $form['yaxis']['inherit_yaxis']['#default_value'] = $this->configuration['inherit_yaxis'];
  ...
  public function build() {
    ...
    if ($options['inherit_yaxis'] == 1) {
      $secondaryOptions['inherit_yaxis'] = 0;
